...
class _UpdateDateState extends State<UpdateDate> {
  ...
  Future getDate(Map map) async {
    safedate = fertiledate = ovulationdate = postdate = [];
  ...
  Widget build(BuildContext context) {
      ...
      getuserData().then((value) {
        ...
        Provider.of<UserProvider>(context, listen: false)
          ...
          getDate({
            ...
            "type": "not concieve",
            "motherOrFather": userdetails.userdetails['status']
          }).then((value) {});
        });
      });
    }
    ...
    void selctionChanged(CalendarSelectionDetails details) {
      _calendarController1.selectedDate = details.date;
      _calendarController2.selectedDate = details.date;
      _dateTime = details.date!;
    }

    void updateDate(DateTime details) {
      if(mounted) {
        setState(() {
          isLoading = false;
        });
        getDate({
          ...
          "imei": deviceid,
          "userId": user['userid'],
          "date": DateFormat('yyyy-MM-dd').format(details).toString(),
          "type": "not concieve",
          "motherOrFather": userdetails.userdetails['status']
        }).then((value) {
          _calendarController1.selectedDate = details;
          _calendarController2.selectedDate = details;
          _dateTime = details;
          setState(() {});
        });
      }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Menstruation Date Cycle',
            style: TextStyle(fontFamily: 'SourceSandPro', fontSize: 20,fontWeight: FontWeight.bold)),
        centerTitle: true,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: SfCalendar(
                        ...
                        onSelectionChanged: selctionChanged,
